...
<div class="split right col-sm-6">
    <div class="centered">
      ...
      <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email"  placeholder="Doctor Id" size="40" name="email" value="{{ old('email') }}" required autofocus>
                    ...
                    <br><br>
                        <div class="form-group row mb-0">
                               ...
                               <footer class="footer">
                                Don't have an account yet? <a href="/medura/doctor/register">  Sign up! </a>
